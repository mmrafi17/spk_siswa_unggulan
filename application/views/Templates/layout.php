...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <h5 class="text-border">Koperasi Simpan Pinjam</h5>
      ...
      <li <?= $this->uri->segment(1) == 'laporan' || $this->uri->segment(1) == '' ? 'class="nav-item active"' :'class="nav-item"' ?>>
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headin gTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('laporan/nasabah');?>">Laporan Nasabah</a>
            <a class="collapse-item" href="<?= base_url('laporan/simpanan');?>">Laporan Simpanan</a>
            <a class="collapse-item" href="<?= base_url('laporan/pinjaman');?>">Laporan Pinjaman</a>
            <a class="collapse-item" href="<?= base_url('laporan/SHU');?>">Laporan SHU</a>
          </div>
        </div>
      </li>
