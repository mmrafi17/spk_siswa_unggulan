            ...
            <tr>
              ...
              <?php 
                while($row = $query->unbuffered_row()){
                  ...
                  $row2= $this->db->query("SELECT * FROM nilai_matriks WHERE id_kriteria='$id_kriteria'");

                  while($dkuadrat = $row2->unbuffered_row()){
                    $kuadrat = $kuadrat + ($dkuadrat->nilai*$dkuadrat->nilai);
                  }
                ?>
